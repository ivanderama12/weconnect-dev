...
const AdminNavbar = () => {
    return ( <
        ...
        to = '/admin/users' > < img className = 'menu-icon'
        src = { usericon }
        alt = 'users' / > Manage Users < /Dropdown.Item> <
        Dropdown.Item as = { Link }
        to = '/admin/messages' > < img className = 'menu-icon'
        src = { msgicon }
        alt = 'msgs' / > Messages < /Dropdown.Item> <
        Dropdown.Item as = { Link }
        to = '/admin/agreements' > < img className = 'menu-icon'
        src = { agreeicon }
        alt = 'agreements' / > View Agreements < /Dropdown.Item> { /* <Dropdown.Item as={Link} to='/admin/' >Change Password</Dropdown.Item> */ } <
        Dropdown.Divider / >
        <
        Dropdown.Item as = { Link }
        to = '/' > < img className = 'menu-icon'
        src = { logouticon }
        alt = 'logout' / > Logout < /Dropdown.Item> <
        /Dropdown.Menu>
        ...
        <
        Dropdown.Item as = { Link }
        to = '/' > Separated link < /Dropdown.Item> <
        /Dropdown.Menu> <
        /Dropdown> <
        /NavB> <
        /NavB> <
